jQuery(document).ready(function () {
    ...
    jQuery(".toggle").on("click", function (event) {
      ...
      , openedSign: "&#x25B4"
        ...
        e.hide(), e.css("left", "0"), e.stop(true, true).delay(100).fadeIn(100, "easeOutCubic")
    }, function () {
    ...
    function slideEffectAjax() {
        jQuery(".mini-cart").mouseenter(function () {
            jQuery(this).find(".top-cart-content").stop(true, true).slideDown()
        }), jQuery(".mini-cart").mouseleave(function () {
...
jQuery('.show_hide').on("click", function () {
    jQuery("#hideShow").show(500);
    jQuery("#hideShow1").hide(200);
});
jQuery('.show_hide1').on("click", function () {
    jQuery("#hideShow1").show(1000);
    jQuery("#hideShow").hide(200);
});
